#!/bin/bash
#SBATCH --job-name=0004_20260813_evaluate_finding_utility_and_visualize
#SBATCH --partition=small-andre01
#SBATCH --output=/workspace/andre01/honzawa/02-playground/color-normalization-comparison/logs/0004_20260813_evaluate_finding_utility_and_visualize/%j_0004_20260813_evaluate_finding_utility_and_visualize.out
#SBATCH --error=/workspace/andre01/honzawa/02-playground/color-normalization-comparison/logs/0004_20260813_evaluate_finding_utility_and_visualize/%j_0004_20260813_evaluate_finding_utility_and_visualize.out
...
#SBATCH --mem=48g
#SBATCH --time=1:00:00
# CPUのみ(GPU不要): has_findingプローブはロジスティック回帰、可視化はt-SNE
# (998スライドx8パッチ=約8000点)を4手法分。--timeは未検証の初期見積り。
...
# #SBATCH --output=/workspace/andre01/honzawa/02-playground/color-normalization-comparison/logs/0004_20260813_evaluate_finding_utility_and_visualize/%A_%a_0004_20260813_evaluate_finding_utility_and_visualize.out
# #SBATCH --error=/workspace/andre01/honzawa/02-playground/color-normalization-comparison/logs/0004_20260813_evaluate_finding_utility_and_visualize/%A_%a_0004_20260813_evaluate_finding_utility_and_visualize.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0004_20260813_evaluate_finding_utility_and_visualize"
...
# 0003と同じ理由(data/raw_slideを含むdata/全体の丸ごとrsyncが無駄)で両方無効化。
